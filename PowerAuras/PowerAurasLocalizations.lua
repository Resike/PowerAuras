...
aideBuff = "Enter here the name or id of the buff, or a part of the name, which must activate/deactivate the effect. You can enter several names. (ex: Super Buff/Power/6673)",
aideBuff2 = "Enter here the name or id of the debuff, or a part of the name, which must activate/deactivate the effect. You can enter several names. (ex: Dark Disease/Plague/1715)",
