...
IsClassic = WOW_PROJECT_ID == WOW_PROJECT_CLASSIC or WOW_PROJECT_ID == WOW_PROJECT_BURNING_CRUSADE_CLASSIC or WOW_PROJECT_ID == WOW_PROJECT_WRATH_CLASSIC,
IsBCClassic = WOW_PROJECT_ID == WOW_PROJECT_BURNING_CRUSADE_CLASSIC,
IsWrathClassic = WOW_PROJECT_ID == WOW_PROJECT_WRATH_CLASSIC,
...
{
	[-1] = 100,
	[Enum.PowerType.Mana] = 100,
	[Enum.PowerType.Rage] = 100,
	[Enum.PowerType.Focus] = 100,
	[Enum.PowerType.Energy] = 100,
	[Enum.PowerType.Runes] = 100,
	[Enum.PowerType.RunicPower] = 100,
	[Enum.PowerType.SoulShards] = 5,
	--[SPELL_POWER_LUNAR_ECLIPSE] = 100,
	--[SPELL_POWER_SOLAR_ECLIPSE] = 100,
	[Enum.PowerType.LunarPower] = 100,
	--[SPELL_POWER_DEMONIC_FURY] = 1000,
	[Enum.PowerType.HolyPower] = 5,
	[Enum.PowerType.Alternate] = 100,
	--[SPELL_POWER_DARK_FORCE] = 5,
	[Enum.PowerType.Chi] = 6,
	--[SPELL_POWER_SHADOW_ORBS] = 5,
	[Enum.PowerType.Insanity] = 100,
	[Enum.PowerType.Maelstrom] = 150,
...
{
	[-1] = "inv_battery_02",
	[Enum.PowerType.Mana] = "inv_elemental_primal_mana",
	[Enum.PowerType.Rage] = "ability_warrior_rampage",
	[Enum.PowerType.Focus] = "ability_hunter_mastermarksman",
	[Enum.PowerType.Energy] = "inv_battery_02",
	[Enum.PowerType.Runes] = "spell_deathknight_runetap",
	[Enum.PowerType.RunicPower] = "spell_arcane_arcane01",
	[Enum.PowerType.SoulShards] = "inv_misc_gem_amethyst_02",
	--[SPELL_POWER_LUNAR_ECLIPSE] = "ability_druid_eclipse",
	--[SPELL_POWER_SOLAR_ECLIPSE] = "ability_druid_eclipseorange",
	[Enum.PowerType.LunarPower] = "ability_druid_eclipse",
	--[SPELL_POWER_DEMONIC_FURY] = "ability_warlock_eradication",
	[Enum.PowerType.HolyPower] = "spell_holy_lightsgrace",
	[Enum.PowerType.Alternate] = "inv_battery_02",
	--[SPELL_POWER_DARK_FORCE] = "spell_arcane_arcanetorrent",
	[Enum.PowerType.Chi] = "class_monk",
	--[SPELL_POWER_SHADOW_ORBS] = "spell_priest_shadoworbs",
	[Enum.PowerType.Insanity] = "spell_priest_shadoworbs",
	[Enum.PowerType.Maelstrom] = "spell_shaman_maelstromweapon",
...
{
	--[PowaAuras.Spells.ACTIVE_TALENT_GROUP_CHANGED] = true,
